...
This project can be run in IntelliJ IDEA. To launch it correctly, enter the required parameters at Run -> Edit Configurations -> Application -> App -> Program arguments.
